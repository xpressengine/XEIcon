...
gulp.task("sass", function () {
    ...
    return gulp
        .src(["./src/versions/" + latest + "/style.css", "./src/sass/xeicon.scss"])
...
gulp.task("gh:deploy", function () {
    return gulp
        .src("./dist/**/*", { dot: true, encoding: false })
        .pipe(ghPages());
});

/* gh-pages */
gulp.task("gh:copy-lib", function () {
    return gulp
        .src(["./xeicon.css", "./xeicon.min.css", "./fonts/**/*"], {
            base: "./",
            encoding: false,
        })
        .pipe(gulp.dest("./dist"));
...
gulp.task("gh:copy-assets", function () {
    return gulp
        .src("./src/template/assets/**/*", { encoding: false })
...
gulp.task("gh:twig-other", function () {
    ...
    return gulp
        .src(["./src/template/*.twig", "!**/library.twig"])
        .pipe(
            twig({
                data: {
...
function getIcons(version) {
    ...
    let selection = JSON.parse(
        fs.readFileSync("./src/versions/" + version + "/selection.json").toString(),
    ).icons;
